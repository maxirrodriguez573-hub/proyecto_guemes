...
# Agregar gasto
def agregar_gasto(conn, telegram_usuario_id : str, categoria_id : int, comercio_id : int, monto : float, recibo_file_id : str, descripcion : str|None = None ,fecha : str|None = None):
    if not fecha:
...
# Eliminar gasto
def eliminar_gasto(conn, gasto_id):
    cursor = conn.cursor()
